...
<body class="atm-background">
    ...
    <form method="post" class="container-fluid">
        <div class="row">
            <div class="col-1"></div>
            <div class="col-5 h4">
                <div class="row"><span class="mb-5 display-5">INFORMANTION</span><br></div>
                <p>The automated teller machine (ATM) system provides a convenient and secure way for customers to withdraw cash, deposit funds, transfer money between accounts, and check their account balances. With the new ATM system, customers can enjoy faster transaction times, improved accessibility, and enhanced security features.</p>
            </div>
            <div class="col-5 h4">
                <div class="row"><span class="mb-5 display-5">24/7 SERVES</span><br></div>
                <p style="text-align: center;"><br>Contact-no:- +91-918-299-9725 <br><br> Email-id:- hacker.bank@gmail.com</p>
            </div>
            <div class="col-1"></div>
        </div>
        <center>
            <div class="row submit">
                <div class="col-4"></div>
                <div class="col-4">
                    <input type="submit" id="Exit" name="Exit" value="BACK">
                </div>
                <div class="col-4"></div>
            </div>
        </center>
