...
if (isset($_POST['with-draw'])) {
    header("Location:mini-state-draw.php");
}
if (isset($_POST['deposit'])) {
    header("Location:mini-state-deposit.php");
}
if (isset($_POST['both'])) {
    header("Location:mini-statement.php");
}
        ...
        <form class="container" method="post">
            <div class="row">
                <div class=" col bc display-1">
                    Please Select your type for mini-statement
                </div>
            </div>
            <div class="abc">
                <div class="row">
                    <div class="col-4">
                        <input type="submit" class="btn" name="with-draw" value="WITH DRAW">
                    </div>
                    <div class="col-4"></div>
                    <div class="col-4">
                        <input type="submit" class="btn" name="deposit" value="DEPOSIT">
                    </div>
                </div>
                <div class="row">
                    <div class="col-4"></div>
                    <div class="col-4">
                        <input type="submit" class="btn" name="both" value="BOTH">
                    </div>
                    <div class="col-4"></div>
                </div>
                <div class="row">
