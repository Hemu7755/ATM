...
$getuserDataQuery = mysqli_query($conn, "SELECT username, AC_no, create_date_time FROM login WHERE log_id='$id'");
$userData = mysqli_fetch_assoc($getuserDataQuery);

$transactionsQuery = mysqli_query($conn, "SELECT ac_id, with_draw,avl_bal, create_date_time FROM acc_table WHERE log_id='$id' AND with_draw > 0 ORDER BY create_date_time");
?>
        ...
        <div class="table-container">
            <form action="" method="post">
                <table>
                    ...
                    while ($transaction = mysqli_fetch_assoc($transactionsQuery)) {
                            ...
                            <tr>
                                ...
                                <td><?php echo $transaction['with_draw']; ?></td>
                ...
                <div class="row container-fluid">
                    <div class="col-4">
                        <input type="submit" name="Exit" value="MENU" class="btn">
                    </div>
                    <div class="col-4">
                    </div>
                    <div class="col-4">
