...
$balanceQuery = mysqli_query($conn, "SELECT atm_bal FROM atm_table WHERE atm_id='1'");
$balanceData = mysqli_fetch_assoc($balanceQuery);
$userBalance = $balanceData['atm_bal'];
?>
...
<head>
    ...
    <title>admin BALANCE ENQUIRY</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body class="atm-background">
    ...
    <center>
        <form class="container mt-5" method="post">
            <div class="row">
                <div class="col a">
                    <p class="display-3">USER Balance: </p><input type="text" id="amount" name="amount" value="<?= $userBalance ?>" disabled>
                </div>
            </div>
            <div class="row">
                <div class="col-4">
                    <input type="submit" class="btn" id="cancle" name="cancle" value="CANCLE">
                </div>
                <div class="col-4"></div>
                <div class="col-4">
