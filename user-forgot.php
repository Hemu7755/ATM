...
if(isset($_POST['submit']))
{
    ...
    $pin=$_POST['new'];
    $updateqry=mysqli_query($conn,"UPDATE login SET password='$pin' WHERE   username='$username'") or die(mysqli_error($conn));
    if($updateqry!="")
        {
            echo "<script>";
        ...
        <form class="container" method="post">
            ...
            <div class="abc">
                <div class="row">
                    ...
                    <div class="col-6">
                        <input type="password" id="new" name="new" placeholder="Enter your new password" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-4"></div>
