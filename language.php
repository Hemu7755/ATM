    ...
    <style>
        *{
        ...
        .abc{
            ...
            background-position: center;
            background-size: cover;
            background-image: url('World_04.webp');
            font-weight: bold;
            border-radius: 10px;
    ...
    <center>
        <div >
            <form class="container" method="post">
                <div class="row bc mt-5 display-2">
                    <div class="col">Please select your language</div>
                </div>
                <div class="abc">
                    <div class="row">
                        <div class="col-4"></div>
                        <div class="col-4">
                            <input type="submit" class="btn" id="English" name="English" value="ENGLISH">
                        </div>
                        <div class="col-4"></div>
                    </div>
                    <div class="row">
                        <div class="col-4">
                            <input type="submit" class="btn" id="Telugu" name="Telugu" value="తెలుగు">
                        </div>
                        <div class="col-4"></div>
                        <div class="col-4">
                            <input type="submit" class="btn" id="Hindi" name="Hindi" value="हिन्दी">
                        </div>                        
                    </div>
                    <div class="row">
                        <div class="col-4"></div>
                        <div class="col-4">
                            <input type="submit" class="btn" id="OTHERS" name="OTHERS" value="OTHERS">
                        </div>
                        <div class="col-4"></div>
                    </div>
                </div>
