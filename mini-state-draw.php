...
$transactionsQuery = mysqli_query($conn, "SELECT ac_id, with_draw,avl_bal, create_date_time FROM acc_table WHERE log_id='$id' AND with_draw > 0 ORDER BY create_date_time DESC LIMIT 5");
?>
