...
$transactionsQuery = mysqli_query($conn, "SELECT ac_id,deposit,avl_bal, create_date_time FROM acc_table WHERE log_id='$id' AND deposit > 0 ORDER BY create_date_time");
?>
