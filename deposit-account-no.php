...
if (isset($_POST['submit'])) {
    ...
    $qry = mysqli_query($conn, "SELECT * FROM login WHERE status='1' AND AC_no = '$acc_no' AND log_id='$id'") or die(mysqli_error($conn));

    if ($qry && mysqli_num_rows($qry) > 0) {
        header("location: deposit-pin.php");
        exit();
    } else {
        echo <<<EOL
            <!DOCTYPE html>
            ...
            <head>
                ...
                <title>Invalid Account Number</title>
            </head>
            <body>
                ...
                <script>
                    Swal.fire({
                        ...
                        window.location.href = 'deposit-account-no.php';
                    });
                </script>
            </body>
            </html>
        ...
        <form class="container" method="post">
            ...
            <div class="abc">
                <div class="row">
                    <div class="col-4"></div>
                    <div class="col-4">
                        <input type="number" id="account-no" name="account-no" placeholder="Enter your Account No" required>
                    </div>
                    <div class="col-4"></div>
                </div>
                <div class="row">
